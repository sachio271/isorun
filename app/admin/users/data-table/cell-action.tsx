...
export const CellAction: React.FC<CellActionProps> = ({ user }) => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      showToast({ title: "Success", description: "Password reset successfully!", type: "success" })
    } catch {
      showToast({ type: "error", title: "Error", description: "An error occurred while processing your request." })
    }
  }
